    ...
    var jBoxLogin = {
        ...
        html: {
          login: `
            ...
            <div><span class="login-textfield">Hãy điền đầy đủ thông tin sau để chúng tôi có thể liên lạc với bạn sớm nhất</span></div>
                <div class="login-body">
                    ...
                    <input type="text" id="phone" class="login-textfield" placeholder="Số điện thoại" autocorrect="off" autocapitalize="off" spellcheck="false">
                    <textarea class="login-textfield" placeholder="Lời nhắn cho chúng tôi..."></textarea>
                    <button class="login-button">Gửi</button>
                </div>
            </div>
