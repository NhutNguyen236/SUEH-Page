...
// Nice one tho but it sounds like testers work here, it is going to confuse the rest of the codes down there
var jBoxLogin = {
    jBox: null,
    ...
    html: {
      login: `
        <div id="LoginContainer-login" class="login-container">
            <div class="login-body">
                <input type="text" id="loginUsername" class="login-textfield" placeholder="Họ và tên" autocorrect="off" autocapitalize="off" spellcheck="false">
                <input type="text" id="loginPassword" class="login-textfield" placeholder="Email" autocorrect="off" autocapitalize="off" spellcheck="false">
                <input type="text" id="loginPassword" class="login-textfield" placeholder="Số điện thoại" autocorrect="off" autocapitalize="off" spellcheck="false">
                <div class="login-remember">
                    <div class="login-checkbox">
                        <div class="login-checkbox-check"></div>
                    </div>
                    <div class="login-checkbox-label">Remember me</div>
                    <input type="hidden" name="login-remember" value="1">
                </div>
                <button class="login-button">Login</button>
            </div>
            <div class="login-footer"><span onclick="jBoxLogin.jBox.showContent(\'register\')">Create new account</span>
                <br><span style="display: none" onclick="jBoxLogin.jBox.showContent(\'password-recovery\')">Forgot password?</span>
            </div>
        </div>
